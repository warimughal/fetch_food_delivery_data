...
class ShawarmaTab extends StatefulWidget {
  final String searchQuery;

  ShawarmaTab({required this.searchQuery});

  @override
  _ShawarmaTabState createState() => _ShawarmaTabState();
}

class _ShawarmaTabState extends State<ShawarmaTab> {
...
// Function to show the product details dialog
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: _firestore.collection("shawarma").snapshots(),
