...
class ZingerBurgerTab extends StatefulWidget {
  final String searchQuery; // Accept the search query as a parameter

  ZingerBurgerTab({required this.searchQuery});

  @override
  _ZingerBurgerTabState createState() => _ZingerBurgerTabState();
}

class _ZingerBurgerTabState extends State<ZingerBurgerTab> {
...
// Function to show the product details dialog
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: _firestore.collection("zinger_burger").snapshots(),
