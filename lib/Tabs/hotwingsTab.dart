...
class HotWingsTab extends StatefulWidget {
  final String searchQuery; // Accept the search query as a parameter

  HotWingsTab({required this.searchQuery});

  @override
  _HotWingsTabState createState() => _HotWingsTabState();
}

class _HotWingsTabState extends State<HotWingsTab> {
...
// Function to show the product details dialog
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: _firestore.collection("hot_wings").snapshots(),
