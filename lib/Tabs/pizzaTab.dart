// ignore_for_file: library_private_types_in_public_api, prefer_const_constructors, use_key_in_widget_constructors, unused_local_variable, unnecessary_null_in_if_null_operators, prefer_const_constructors_in_immutables, file_names, unused_element, sized_box_for_whitespace, unused_field, avoid_print
...
class PizzaTab extends StatefulWidget {
  ...
  PizzaTab({required this.searchQuery});
...
// Function to show the product details dialog
  ...
  // Function to add an item to the Firestore collection
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: _firestore.collection("pizza").snapshots(),
